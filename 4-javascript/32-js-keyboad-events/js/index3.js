window.onload = () => {
    ...
    setEvent('keyup', quatityInput, priceInput, quatityInput, resultSpan,'quantity')
    // quatityInput.quatityInput('keyup',function (e) {     let price =
    // parseFloat(priceInput.value)     let quantity=parseFloat(quatityInput.value)
    // resultSpan.innerText = price * quantity
    // calculator(resultSpan,price,quantity) })

    setEvent('change', quatityInput, priceInput, quatityInput, resultSpan,'quantity')
