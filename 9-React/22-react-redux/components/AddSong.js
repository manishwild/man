    ...
    return (
      <div className="col-md-12">
        <div className="input-group mb-3">
          ...
          <input type="text" className="form-control" value={this.state.songTitle} onChange={this.onTitleChange} placeholder="Song Title"/>
        </div>
        <div className="input-group mb-3">
          <div className="input-group-prepend">
            <span className="input-group-text">Song Duration</span>
          </div>
          <input type="text" className="form-control" value={this.state.songDuration} onChange={this.onDurationChange} placeholder="Song Duration"/>
        </div>
